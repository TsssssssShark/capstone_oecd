...
gtsave(
  accessibility_gt_1,
  filename = file.path(fig_output_dir, "accessibility_table_1.png"),
  vwidth = 800,
  vheight = 800
)
...
gtsave(
  accessibility_gt_2,
  filename = file.path(fig_output_dir, "accessibility_table_2.png"),
  vwidth = 800,
  vheight = 800
)
```
...
index_overall_long <- index_overall %>%
  filter(!is.na(accessibility_contrib) & !is.na(comprehensiveness_contrib)) %>%
